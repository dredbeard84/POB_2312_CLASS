...
// 1.2. Вывести "e" с точностью до 10-х
...
//Console.WriteLine("Введите v0: "); // 1
//double v0 = double.Parse(Console.ReadLine());
//Console.WriteLine("Введите a: "); // 2
//double a = double.Parse(Console.ReadLine());
//Console.WriteLine("Введите t: "); // 3
//double t = double.Parse(Console.ReadLine());
//double s = v0 * t + (a * t * t) / 2;
//Console.WriteLine($"Результат: {s:F2}"); // = 12
...
//Console.WriteLine($"Результат: {L:F2}");
