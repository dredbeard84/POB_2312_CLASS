namespace Thema25_4
{
    public partial class Form1 : Form
    {
        ...
        private void tb9x13_KeyPress(object sender, KeyPressEventArgs e)
        {
            tb15x20.Clear();
            tb10x15.Clear();
            Radio_Click(sender, e, tb9x13);
        }

        private void Radio_Click(object sender, KeyPressEventArgs e, TextBox textBox)
        {
