...
namespace FileManager_2312_Nepomiluev
{
    internal class Program
    {
        ...
        public static void CommandParser(string command)
        {
            ...
            {
                case "cd":
                    if (commandParts.Length == 1)// || (command == "cd")
                    {
                    ...
                    else if (commandParts.Length == 2)
                    {
                        ...
                        else if (commandParts[1].Contains('\\'))// абсолютный путь - весь целиком
                        {
                        ...
                        {
                            if (Directory.Exists(_currentDir + commandParts[1]))// проверка на относительный путь
                            {
                                _currentDir += commandParts[1];
                            }
                        }
        ...
        public static void CommandInputProcess()
        {
            ...
            do
            {
                ...
                ConsoleKey key = (ConsoleKey)pressedKey;// значение клавиша, которую нажали
